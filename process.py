...
def generate_dataset(raw_dir, cache_dir, output_dir):
    ...
    depth_files = dataset_files['depth']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--raw_dir', help='Path to the raw dataset directory.')
    parser.add_argument('--output_dir', help='Path to store the dataset.')
    parser.add_argument('--cache_dir', help='Path to use as a cache.')
